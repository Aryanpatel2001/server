...
courseRouter.put("/add-review/:id", user_controllers_1.updateAccessToken, auth_1.isAuthenticated, course_controller_1.addReviews);
...
courseRouter.get("/get-admin-courses", user_controllers_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAdminAllCourses);
courseRouter.post("/getVdoCipherOTP", course_controller_1.generateVideoUrl);
courseRouter.delete("/delete-courses/:id", user_controllers_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.deleteCourse);
